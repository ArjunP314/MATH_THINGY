...
import geometry as gm # type: ignore
from geometry import Angle, Direction, Length, Ratio # type: ignore
from geometry import Circle, Line, Point, Segment # type: ignore
from geometry import Measure, Value # type: ignore
import graph_utils as utils # type: ignore
import numericals as nm # type: ignore
import problem # type: ignore 
from problem import Dependency, EmptyDependency # type: ignore
...
class Graph:
  ...
  def derive_algebra(
      ...
      dict[str, list[tuple[Point, ...]]], dict[str, [tuple[Point, ...]]] # type: ignore
  ]:
  ...
  def get(self, pointname: str, default_fn: Callable[str, Point]) -> Point: # type: ignore
