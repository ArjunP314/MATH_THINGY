...
import beam_search # type: ignore
import decoder_stack # type: ignore
import gin # type: ignore
import jax # type: ignore
import jax.numpy as jnp # type: ignore
from transformer import models # type: ignore
...
class DecoderOnlyLanguageModelGenerate(models.DecoderOnlyLanguageModel):
  ...
  def generate(
      self, inputs: ...
  ) -> tuple[tuple[dict[str, jnp.ndarray, ...], ...], jnp.ndarray]: # type: ignore
